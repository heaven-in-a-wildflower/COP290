...
function App() {
    // State to manage stock data and search functionality
    ...
    // State for search input and autocomplete options
    ...
    // Function to handle stock selection from autocomplete
                ...
                <Header>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <div style={{ color: 'white', fontSize: '25px', marginRight: '60px' }}>NSE Information</div>
                            <Menu theme="dark" mode="horizontal" style={{ lineHeight: '64px' }}>
                                <Menu.Item key="1" style={{ minWidth: '100px' }}>
                                    <Link to="/">Home</Link>
                                </Menu.Item>
                                <Menu.Item key="2" style={{ minWidth: '150px' }}>
                                    <Link to="/compare">Compare Stocks</Link>
                                </Menu.Item>
                                <Menu.Item key="3" style={{ minWidth: '120px' }}>
